...
var CleverTap = function (CleverTapAccountId, CleverTapAccountPasscode, CleverTapRegion) {
    ...
    this.api = new CleverTapAPI(CleverTapAccountId, CleverTapAccountPasscode, CleverTapRegion);
};
...
var init = (CleverTapAccountId, CleverTapAccountPasscode, CleverTapRegion) => {
    return new CleverTap(CleverTapAccountId, CleverTapAccountPasscode, CleverTapRegion);
};
